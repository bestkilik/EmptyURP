...
{
	[Serializable]
	public class TipsWindowEditor : MenuParent
	{
		...
		public TipsWindowEditor( AmplifyShaderEditorWindow parentWindow ) : base( parentWindow, 0, 0, 0, 64, "Tips", MenuAnchor.TOP_LEFT, MenuAutoSize.NONE )
		{
