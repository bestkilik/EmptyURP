Shader /*ase_name*/ "Hidden/IGG/Universal/Hair" /*end*/
{
	Properties
	{
		...
		*/
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN /*ase_frag_input*/ ) : SV_Target
			{
				...
				float3 Tangent = /*ase_frag_out:Tangent;Float3;11*/float3(1, 0, 0)/*end*/;
				...
				float HairMask = /*ase_frag_out:HairMask;Float;12*/1.0/*end*/;
