Shader "GE/Scene/Terrain/SimpleTerrain"
{
	Properties
	{
		...
		_Tex0("Splat0", 2D) = "white" {}
		_Tex1("Splat1", 2D) = "white" {}
		_Tex2("Splat2", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float total = tex2DNode17.r + tex2DNode17.g + tex2DNode17.b + tex2DNode17.a;
				tex2DNode17 /= total;
				...
				float3 Albedo = (( _Color * ( ( tex2D( _Tex0, uv_Tex0 ) * mask019 ) + ( tex2D( _Tex1, uv_Tex1 ) * mask120 ) + ( tex2D( _Tex2, uv_Tex2 ) * mask221 ) ) )).rgb;
				...
				coverMask *= (1 - tex2Dlod(SnowMaskTex, float4(brushUV, 0, 1)).r);
