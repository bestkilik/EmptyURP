Shader "GE/Scene/SimpleGlow_TexFlow"
{
	Properties
	{
		...
		[ASEEnd][Toggle]_invFlow("Invert Flow", Int) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 tex2DNode114 = tex2D( _FlowMap, uv_FlowMap );
				float2 temp_cast_1 = (1.0).xx;
				float2 temp_output_30_0 = ( ( ( (tex2DNode114).rg * 2.0 ) - temp_cast_1 ) * _FlowSpeed * 0.5 );
				...
				float temp_output_98_0 = ( 1.0 - tex2DNode114.b );
